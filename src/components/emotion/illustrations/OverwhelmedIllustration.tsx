    ...
    <Svg width={size} height={size} viewBox="0 0 100 100">
      <Defs>
        <RadialGradient id="glowGrad" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor={colors.mood.overwhelmed} stopOpacity={0.85} />
          <Stop offset="30%" stopColor={colors.mood.overwhelmed} stopOpacity={0.3} />
          <Stop offset="100%" stopColor={colors.mood.overwhelmed} stopOpacity={0} />
        </RadialGradient>
        <LinearGradient id="orbGrad" x1="0" y1="0" x2="1" y2="1">
          <Stop offset="0%" stopColor={colors.mood.overwhelmed} />
          <Stop offset="100%" stopColor={colors.mood.anxious} />
        </LinearGradient>
      </Defs>
