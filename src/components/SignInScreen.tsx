  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={isLoading}
        className="mt-4 text-accent hover:text-accentAlt font-sans font-medium text-[13px] transition-colors duration-150 focus:outline-none cursor-pointer disabled:opacity-50"
      >
        Forgot password?
      </button>
