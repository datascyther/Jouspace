...
export const ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Success State */}
      {isEmailSent ? (
        <div className="w-full max-w-[320px] bg-accentSoft border border-border rounded-xl px-4 py-4 mb-6">
          <p className="font-sans text-[13px] text-primaryText text-center">
