...
export const AppScreen: React.FC<AppScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5] text-[#0D102B] font-sans antialiased flex flex-col items-center justify-start py-0 md:py-6 selection:bg-[#6D4FD7]/15">
      ...
      <div
        className={`w-full bg-[#FBF9F5] h-[100dvh] md:h-[880px] md:my-4 md:rounded-[40px] md:border md:border-[#E7E1EF] md:shadow-2xl flex flex-col overflow-hidden ${className}`}
      >
        {showStatusBar && (
          <div className="flex items-center justify-between px-7 pt-safe pt-3 pb-1 text-[13px] font-semibold text-[#0D102B] select-none tracking-tight shrink-0">
            <span>9:41</span>
